...
export const SearchComponent = ({ allPlayers }: { allPlayers: Player[] }) => {
  ...
  <div className="flex mx-auto">
    ...
    <input onChange={(e) => {setSearchTerm(e.target.value)}} value={searchTerm} type="text" id="website-admin" className="rounded-none rounded-e-lg  border bg-light-dark block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5   dark:placeholder-gray-400" placeholder="fastcup nickname"/>
  </div>
