      ...
      <div className='flex flex-row justify-between'>
        <div className="flex flex-col max-w-[717px]">
          ...
          <div className="relative">
              <div className="absolute w-3 h-[45px] top-[72px] left-[39px] bg-white rounded-sm" />
              <PlayerStatsSection />
            </div>
        </div>
        <WindroseChart />
          ...
          <Card className="bg-transparent">
            <CardContent className="p-0">
              <div className="relative">
                ...
                <Image
                  className="absolute w-[1044px] h-[34px] top-4 left-5"
                  width={1044}
                  height={34}
                  alt="Vector"
                ...
                <div className="absolute top-[25px] left-[955px] [font-family:'Nunito',Helvetica] font-normal text-white text-sm">
                  match_stats
                </div>
              </div>
            </CardContent>
